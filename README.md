...
- **UT.6.10x Embedded Systems - Shape The World: <a href="https://www.edx.org/course/embedded-systems-shape-world-utaustinx-ut-6-10x"  target="_blank"> Microcontroller Input/Output</a>** includes Modules 1 to 10. \
  [Certificate]() obtained with a grade of % (*not shown on the certificate but you can find a view [here]()*) \
  [Certifcate Verification]()
- **UT.6.20x Embedded Systems - Shape The World: <a href="https://www.edx.org/course/embedded-systems-shape-world-multi-utaustinx-ut-6-20x" target="_blank"> Multi-Threaded Interfacing</a>** includes Modules 11 to 16. \
  [Certificate]() obtained with a grade of % (*not shown on the certificate but you can find a view [here]()*) \
  [Certifcate Verification]()
